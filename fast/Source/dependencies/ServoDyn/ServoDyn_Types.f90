...
! =========  SrvD_InputFile  =======
  TYPE, PUBLIC :: SrvD_InputFile
    ...
    LOGICAL  :: CompNTRD      !< Compute nacelle twin rotor damper {true/false} [-]
    CHARACTER(1024)  :: NTRDfile      !< File for nacelle twin rotor damper (quoted string) [-]
...
! =========  SrvD_ContinuousStateType  =======
  TYPE, PUBLIC :: SrvD_ContinuousStateType
    ...
    TYPE(TRD_ContinuousStateType)  :: NTRD      !< TRD module states [-]
...
! =========  SrvD_DiscreteStateType  =======
  TYPE, PUBLIC :: SrvD_DiscreteStateType
    ...
    TYPE(TRD_DiscreteStateType)  :: NTRD      !< TRD module states [-]
...
! =========  SrvD_ConstraintStateType  =======
  TYPE, PUBLIC :: SrvD_ConstraintStateType
    ...
    TYPE(TRD_ConstraintStateType)  :: NTRD      !< TRD module states [-]
...
! =========  SrvD_OtherStateType  =======
  TYPE, PUBLIC :: SrvD_OtherStateType
    ...
    TYPE(TRD_OtherStateType)  :: NTRD      !< TRD module states [-]
...
! =========  SrvD_MiscVarType  =======
  TYPE, PUBLIC :: SrvD_MiscVarType
    ...
    TYPE(TRD_MiscVarType)  :: NTRD      !< TRD module misc vars - nacelle [-]
...
! =========  SrvD_ParameterType  =======
  TYPE, PUBLIC :: SrvD_ParameterType
    ...
    LOGICAL  :: CompNTMD      !< Compute nacelle tuned mass damper {true/false} [-]
    LOGICAL  :: CompTTMD      !< Compute tower tuned mass damper {true/false} [-]
    LOGICAL  :: CompNTRD      !< Compute nacelle tuned mass damper {true/false} [-]
    INTEGER(IntKi)  :: NumOuts      !< Number of parameters in the output list (number of outputs requested) [-]
    CHARACTER(1024)  :: RootName      !< RootName for writing output files [-]
    ...
    TYPE(TRD_ParameterType)  :: NTRD      !< TRD module parameters [-]
    REAL(ReKi)  :: AvgWindSpeed      !< average wind speed for the simulation [m/s]
    REAL(ReKi)  :: AirDens      !< air density [kg/m^3]
...
! =========  SrvD_InputType  =======
  TYPE, PUBLIC :: SrvD_InputType
    ...
    TYPE(TRD_InputType)  :: NTRD      !< TRD module inputs [-]
...
! =========  SrvD_OutputType  =======
  TYPE, PUBLIC :: SrvD_OutputType
    ...
    TYPE(TRD_OutputType)  :: NTRD      !< TRD module outputs [-]
...
ENDIF
    ...
    DstInputFileData%CompNTRD = SrcInputFileData%CompNTRD
    DstInputFileData%NTRDfile = SrcInputFileData%NTRDfile
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      ...
      Int_BufSz  = Int_BufSz  + 1  ! CompNTRD
      Int_BufSz  = Int_BufSz  + 1*LEN(InData%NTRDfile)  ! NTRDfile
  IF ( Re_BufSz  .GT. 0 ) THEN 
     ALLOCATE( ReKiBuf(  Re_BufSz  ), STAT=ErrStat2 )
     IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating ReKiBuf.', ErrStat, ErrMsg,RoutineName)
  ...
  END IF
      ...
      Int_Xferred   = Int_Xferred   + 1
        DO I = 1, LEN(InData%TTMDfile)
          ...
          Int_Xferred = Int_Xferred   + 1
        END DO ! I
      IntKiBuf ( Int_Xferred:Int_Xferred+1-1 ) = TRANSFER( InData%CompNTRD , IntKiBuf(1), 1)
      Int_Xferred   = Int_Xferred   + 1
        DO I = 1, LEN(InData%NTRDfile)
          IntKiBuf(Int_Xferred) = ICHAR(InData%NTRDfile(I:I), IntKi)
          Int_Xferred = Int_Xferred   + 1
        END DO ! I
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      DO I = 1, LEN(OutData%TTMDfile)
        ...
        Int_Xferred = Int_Xferred   + 1
      END DO ! I
      OutData%CompNTRD = TRANSFER( IntKiBuf( Int_Xferred ), mask0 )
      Int_Xferred   = Int_Xferred + 1
      DO I = 1, LEN(OutData%NTRDfile)
        OutData%NTRDfile(I:I) = CHAR(IntKiBuf(Int_Xferred))
        Int_Xferred = Int_Xferred   + 1
      END DO ! I
   ...
   ErrMsg  = ""
    DstContStateData%DummyContState = SrcContStateData%DummyContState
      ...
      CALL TMD_CopyContState( SrcContStateData%TTMD, DstContStateData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyContState( SrcContStateData%NTRD, DstContStateData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
! 
  ...
  CALL TRD_DestroyContState( ContStateData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      IF(ALLOCATED(Int_Buf)) THEN ! TTMD
         ...
         DEALLOCATE(Int_Buf)
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackContState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! NTRD
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! NTRD
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! NTRD
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  Int_Xferred = 1
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackContState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackContState( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
! 
   ...
   ErrMsg  = ""
      ...
      CALL TMD_CopyDiscState( SrcDiscStateData%TTMD, DstDiscStateData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyDiscState( SrcDiscStateData%NTRD, DstDiscStateData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
! 
  ...
  CALL TRD_DestroyDiscState( DiscStateData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackDiscState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  Int_Xferred = 1
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackDiscState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackDiscState( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
   ...
   ErrMsg  = ""
    DstConstrStateData%DummyConstrState = SrcConstrStateData%DummyConstrState
      ...
      CALL TMD_CopyConstrState( SrcConstrStateData%TTMD, DstConstrStateData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyConstrState( SrcConstrStateData%NTRD, DstConstrStateData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
! 
  ...
  CALL TRD_DestroyConstrState( ConstrStateData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackConstrState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  Int_Xferred = 1
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackConstrState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackConstrState( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
ENDIF
    ...
    DstOtherStateData%GenOnLine = SrcOtherStateData%GenOnLine
      ...
      CALL TMD_CopyOtherState( SrcOtherStateData%TTMD, DstOtherStateData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyOtherState( SrcOtherStateData%NTRD, DstOtherStateData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
ENDIF
  ...
  CALL TRD_DestroyOtherState( OtherStateData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackOtherState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  END IF
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackOtherState( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackOtherState( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
ENDIF
      ...
      CALL TMD_CopyMisc( SrcMiscData%TTMD, DstMiscData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyMisc( SrcMiscData%NTRD, DstMiscData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
ENDIF
  ...
  CALL TRD_DestroyMisc( MiscData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackMisc( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  END IF
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackMisc( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackMisc( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
ENDIF
    ...
    DstParamData%CompNTRD = SrcParamData%CompNTRD
...
ENDIF
    ...
    DstParamData%DLL_InFile = SrcParamData%DLL_InFile
      ...
      CALL TMD_CopyParam( SrcParamData%TTMD, DstParamData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyParam( SrcParamData%NTRD, DstParamData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
ENDIF
  ...
  CALL TRD_DestroyParam( ParamData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackParam( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  END IF
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackParam( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackParam( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
ENDIF
    ...
    DstInputData%GenTrq_prev = SrcInputData%GenTrq_prev
      CALL TMD_CopyInput( SrcInputData%NTMD, DstInputData%NTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyInput( SrcInputData%NTRD, DstInputData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
ENDIF
  ...
  CALL TRD_DestroyInput( InputData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackInput( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  END IF
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackInput( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  END IF
    ...
    DEALLOCATE(mask1)
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackInput( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
ENDIF
      ...
      CALL TMD_CopyOutput( SrcOutputData%TTMD, DstOutputData%TTMD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL TRD_CopyOutput( SrcOutputData%NTRD, DstOutputData%NTRD, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
...
ENDIF
  ...
  CALL TRD_DestroyOutput( OutputData%NTRD, ErrStat, ErrMsg )
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      END IF
      Int_BufSz   = Int_BufSz + 3  ! NTRD: size of buffers for each call to pack subtype
      CALL TRD_PackOutput( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, .TRUE. ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  END IF
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL TRD_PackOutput( Re_Buf, Db_Buf, Int_Buf, InData%NTRD, ErrStat2, ErrMsg2, OnlySize ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL TRD_UnpackOutput( Re_Buf, Db_Buf, Int_Buf, OutData%NTRD, ErrStat2, ErrMsg2 ) ! NTRD 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
END IF ! check if allocated
  ...
  u_out%GenTrq_prev = u1%GenTrq_prev + b0 * t_out
      CALL TMD_Input_ExtrapInterp1( u1%NTMD, u2%NTMD, tin, u_out%NTMD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
      CALL TRD_Input_ExtrapInterp1( u1%NTRD, u2%NTRD, tin, u_out%NTRD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
...
END IF ! check if allocated
  ...
  u_out%GenTrq_prev = u1%GenTrq_prev + b0 * t_out + c0 * t_out**2
      CALL TMD_Input_ExtrapInterp2( u1%NTMD, u2%NTMD, u3%NTMD, tin, u_out%NTMD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
      CALL TRD_Input_ExtrapInterp2( u1%NTRD, u2%NTRD, u3%NTRD, tin, u_out%NTRD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
...
END IF ! check if allocated
      ...
      CALL TMD_Output_ExtrapInterp1( y1%TTMD, y2%TTMD, tin, y_out%TTMD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
      CALL TRD_Output_ExtrapInterp1( y1%NTRD, y2%NTRD, tin, y_out%NTRD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
...
END IF ! check if allocated
      ...
      CALL TMD_Output_ExtrapInterp2( y1%TTMD, y2%TTMD, y3%TTMD, tin, y_out%TTMD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
      CALL TRD_Output_ExtrapInterp2( y1%NTRD, y2%NTRD, y3%NTRD, tin, y_out%NTRD, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
IF (ALLOCATED(y_out%SuperController) .AND. ALLOCATED(y1%SuperController)) THEN
  ALLOCATE(b1(SIZE(y_out%SuperController,1)))
  ALLOCATE(c1(SIZE(y_out%SuperController,1)))
