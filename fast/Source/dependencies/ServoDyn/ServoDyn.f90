...
! This code was generated by Write_ChckOutLst.m at 05-Nov-2015 09:57:49.
   ...
   INTEGER(IntKi), PARAMETER      :: TTMD_YQD  = 15
     ...
     ! Nacelle Twin Rotor Damper (TMD):

   INTEGER(IntKi), PARAMETER      :: NTRD_XS = 16
   INTEGER(IntKi), PARAMETER      :: NTRD_XSD = 17
   INTEGER(IntKi), PARAMETER      :: NTRD_PHI = 18
   INTEGER(IntKi), PARAMETER      :: NTRD_PHID = 19
   INTEGER(IntKi), PARAMETER      :: NTRD_CE1 = 20
   INTEGER(IntKi), PARAMETER      :: NTRD_CE2 = 21
   INTEGER(IntKi), PARAMETER      :: NTRD_FC = 22
   INTEGER(IntKi), PARAMETER      :: NTRD_A = 23
   INTEGER(IntKi), PARAMETER      :: NTRD_VA = 24

     ! The maximum number of output channels which can be output by the code.
   INTEGER(IntKi), PARAMETER      :: MaxOutPts = 24
...
!..................................................................................................................................
   ...
   TYPE(TRD_InitInputType)                        :: TRD_InitInp    ! data to initialize TRD module
   TYPE(TRD_InitOutputType)                       :: TRD_InitOut    ! data from TRD module initialization (not used)
   ...
   END IF
      ...
      !............................................................................................
      ! Initialize the TRD module:
      !............................................................................................
   IF (p%CompNTRD) THEN
      
      TRD_InitInp%InputFile = InputFileData%NTRDfile
      TRD_InitInp%RootName  = TRIM(p%RootName)//'.NTRD' !p%RootName
      TRD_InitInp%Gravity   = InitInp%gravity
      TRD_InitInp%r_N_O_G   = InitInp%r_N_O_G
      
      CALL TRD_Init( TRD_InitInp, u%NTRD, p%NTRD, x%NTRD, xd%NTRD, z%NTRD, OtherState%NTRD, y%NTRD, m%NTRD, Interval, TRD_InitOut, ErrStat2, ErrMsg2 )
         CALL CheckError( ErrStat2, ErrMsg2 )
         IF (ErrStat >= AbortErrLev) RETURN
      
      IF (.NOT. EqualRealNos( Interval, p%DT ) ) THEN
         CALL CheckError( ErrID_Fatal, "TRD time step differs from SrvD time step." )
         RETURN
      END IF      
   ...
   CALL TRD_DestroyInitInput(TRD_InitInp, ErrStat2, ErrMsg2 )   
   CALL TRD_DestroyInitOutput(TRD_InitOut, ErrStat2, ErrMsg2 )   
   ...
   !...............................................................................................................................
      ...
      IF ( ErrID /= ErrID_None ) THEN
         ...
         IF ( ErrStat >= AbortErrLev ) THEN
            ...
            CALL TRD_DestroyInitInput(TRD_InitInp, ErrStat3, ErrMsg3 )
            CALL TRD_DestroyInitOutput(TRD_InitOut, ErrStat3, ErrMsg3 )   
         END IF
...
!..................................................................................................................................
      ...
      IF (p%CompNTRD) THEN
         CALL TRD_End( u%NTRD, p%NTRD, x%NTRD, xd%NTRD, z%NTRD, OtherState%NTRD, y%NTRD, m%NTRD, ErrStat, ErrMsg )
      END IF 
...
!..................................................................................................................................
   ...
   TYPE(TRD_InputType),ALLOCATABLE                :: utrd(:)            ! Inputs at t
   INTEGER(IntKi)                                 :: i               ! loop counter 
   INTEGER(IntKi)                                 :: order
 ...
 IF (p%CompNTRD) THEN  
      ...
      order = SIZE(Inputs)
      ALLOCATE(utrd(order), STAT=ErrStat2)
      IF(ErrStat2 /= 0) THEN
         CALL SetErrStat( ErrID_Fatal, 'Could not allocate TRD input array, utrd', ErrStat, ErrMsg, RoutineName )
         CALL Cleanup()
         RETURN
      END IF
            
         DO i=1,order
            CALL TRD_CopyInput( Inputs(i)%NTRD, utrd(i), MESH_NEWCOPY, ErrStat2, ErrMsg2 )
            CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
         END DO
         ...
         CALL TRD_UpdateStates( t, n, utrd, InputTimes, p%NTRD, x%NTRD, xd%NTRD, z%NTRD, OtherState%NTRD, m%NTRD, ErrStat2, ErrMsg2 )
            CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
...
!..................................................................................................................................
   ...
   IF (p%CompNTRD) THEN 
      CALL TRD_CalcOutput( t, u%NTRD, p%NTRD, x%NTRD, xd%NTRD, z%NTRD, OtherState%NTRD, y%NTRD, m%NTRD, ErrStat2, ErrMsg2 )
      CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
   END IF
...
!   AllOuts(Time) = t    
   ...
   AllOuts(NTRD_XS  ) = x%NTRD%trd_x(1)
   AllOuts(NTRD_XSD ) = x%NTRD%trd_x(2)
   AllOuts(NTRD_PHI ) = x%NTRD%trd_x(3)
   AllOuts(NTRD_PHID) = x%NTRD%trd_x(4)
   AllOuts(NTRD_A   ) = m%NTRD%A
...
!..................................................................................................................................
      ...
      IF (p%CompNTRD) THEN 
         CALL TRD_CalcContStateDeriv( t, u%NTRD, p%NTRD, x%NTRD, xd%NTRD, z%NTRD, OtherState%NTRD, m%NTRD, dxdt%NTRD, ErrStat, ErrMsg )
      END IF
...
!..................................................................................................................................
   ...
   !---------------------- TWIN ROTOR DAMPER ----------------------------------------         
   CALL ReadCom( UnIn, InputFile, 'Section Header: Twin Rotor Damper', ErrStat2, ErrMsg2, UnEc )
      CALL CheckError( ErrStat2, ErrMsg2 )
      IF ( ErrStat >= AbortErrLev ) RETURN
                  
      ! CompNTRD - Compute nacelle tuned mass damper {true/false} (flag):
   CALL ReadVar( UnIn, InputFile, InputFileData%CompNTRD, "CompNTRD", "Compute nacelle twin rotor damper {true/false} (flag)", ErrStat2, ErrMsg2, UnEc)
      CALL CheckError( ErrStat2, ErrMsg2 )
      IF ( ErrStat >= AbortErrLev ) RETURN      
      
      ! NTRDfile - Name of the file for nacelle tuned mass damper (quoted string) [unused when CompNTRD is false]:
   CALL ReadVar( UnIn, InputFile, InputFileData%NTRDfile, "NTRDfile", "Name of the file for nacelle tuned mass dampe [unused when CompNTRD is false] (-)", ErrStat2, ErrMsg2, UnEc)
      CALL CheckError( ErrStat2, ErrMsg2 )
      IF ( ErrStat >= AbortErrLev ) RETURN
   IF ( PathIsRelative( InputFileData%NTRDfile ) ) InputFileData%NTRDfile = TRIM(PriPath)//TRIM(InputFileData%NTRDfile)
...
!..................................................................................................................................
   ...
   p%CompNTRD = InputFileData%CompNTRD
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(25) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                                ...
                                "NTMD_XQD ","NTMD_YQ  ","NTMD_YQD ","NTRD_A   ","NTRD_CE1 ","NTRD_CE2 ","NTRD_FC  ", &
                                "NTRD_PHI ","NTRD_PHID","NTRD_VA  ","NTRD_XS  ","NTRD_XSD ","TTMD_XQ  ","TTMD_XQD ", &
                                "TTMD_YQ  ","TTMD_YQD ","YAWMOM   ","YAWMOMCOM"/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(25) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                BlPitchC1  , BlPitchC2 , BlPitchC3 ,    GenPwr ,     GenTq ,  HSSBrTqC ,   NTMD_XQ , &
                                NTMD_XQD   ,   NTMD_YQ ,  NTMD_YQD ,    NTRD_A ,  NTRD_CE1 ,  NTRD_CE2 ,   NTRD_FC , &
                                NTRD_PHI   , NTRD_PHID ,  NTRD_VA  ,   NTRD_XS ,  NTRD_XSD ,   TTMD_XQ ,  TTMD_XQD , &
                                TTMD_YQ    ,  TTMD_YQD , YawMomCom , YawMomCom /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(25) =  (/ &                     ! This lists the units corresponding to the allowed parameters
                               ...
                               "(m/s)     ","(m)       ","(m/s)     ","(-)       ","(rad)     ","(rad)     ","(kN)      ", &
                               "(rad)     ","(rad/s)   ","(-)       ","(m)       ","(m/s)     ","(m)       ","(m/s)     ", &
                               "(m)       ","(m/s)     ","(kN.m)    ","(kN.m)    "/)
   ...
   InvalidOutput(  NTRD_XS) = ( .not. p%CompNTRD )
   InvalidOutput( NTRD_XSD) = ( .not. p%CompNTRD )
   InvalidOutput( NTRD_PHI) = ( .not. p%CompNTRD )
   InvalidOutput(NTRD_PHID) = ( .not. p%CompNTRD )
   InvalidOutput(   NTRD_A) = ( .not. p%CompNTRD )
   InvalidOutput(  NTRD_VA) = ( .not. p%CompNTRD )
   InvalidOutput( NTRD_CE1) = ( .not. p%CompNTRD )
   InvalidOutput( NTRD_CE2) = ( .not. p%CompNTRD )
   InvalidOutput(  NTRD_FC) = ( .not. p%CompNTRD )
